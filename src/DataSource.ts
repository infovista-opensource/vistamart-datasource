...
export class DataSource extends DataSourceApi<MyQuery, MyDataSourceOptions> {
  ...
  private parseMetricFindQueryResultTag(results: any, removeOption: SelectableValue<string> | null, addWid?: boolean): Array<SelectableValue<string>> {
  ...
  private parseMetricFindQueryResult(results: any, removeOption: SelectableValue<string> | null, addWid?: boolean): Array<SelectableValue<string>> {
    const res = new Array<SelectableValue<string>>();
    if (removeOption !== null) res.push(removeOption);
    if (addWid !== undefined) {
  ...
  private parseMetricFindQueryResultDr(results: any, removeOption: SelectableValue<string> | null): Array<SelectableValue<string>> {
    const res = new Array<SelectableValue<string>>();
    if (removeOption !== null) res.push(removeOption);
  ...
  async getallVista(removeOption: SelectableValue<string>): Promise<Array<SelectableValue<string>>> {
    const result = getBackendSrv().fetch(
      ...
      .pipe(map((data: any) => this.parseMetricFindQueryResult(data, removeOption, true))).toPromise();
    return result;
  }

  async getallInstances(parentInstance: any | undefined, vistaName: any | undefined, removeOption: SelectableValue<string>): Promise<Array<SelectableValue<string>>> {
    ...
    const result = getBackendSrv().fetch(
      ...
      .pipe(map((data: any) => this.parseMetricFindQueryResultTag(data, removeOption))).toPromise();
    return result;
  }

  async getallProperties(vistaName: any | undefined, removeOption: SelectableValue<string>): Promise<Array<SelectableValue<string>>> {
    const iVistaName = getTemplateSrv().replace(vistaName.label, {}, this.interpolateVariable);
    const result = getBackendSrv().fetch(
      {
        method: "GET",
      ...
      .pipe(map((data: any) => this.parseMetricFindQueryResult(data, removeOption))).toPromise();
    return result;
  }

  async getallIndicators(vistaName: any | undefined, removeOption: SelectableValue<string>): Promise<Array<SelectableValue<string>>> {
    const iVistaName = getTemplateSrv().replace(vistaName.label, {}, this.interpolateVariable);
    const result = getBackendSrv().fetch(
      {
        method: "GET",
  ...
  async getallDr(instanceTag: any | undefined, indicatorName: any | undefined, removeOption: SelectableValue<string>): Promise<Array<SelectableValue<string>>> {
    const result = getBackendSrv().fetch(
      {
        method: "GET",
      ...
      .pipe(map((data: any) => this.parseMetricFindQueryResultDr(data, removeOption))).toPromise();
    return result;
  }
  ...
  async metricFindQuery(query: string): Promise<MyMetricFindValue[]> {
    ...
    if (obj.type == "vista") {
      ...
      const result = getBackendSrv().fetch(
        ...
        .pipe(map((data: any) => this.parseMetricFindQueryResult2(data))).toPromise();
      return result;
    }
    if (obj.type == "instance") {
      ...
      const result = getBackendSrv().fetch(
        ...
        .pipe(map((data: any) => this.parseMetricFindQueryResult2Tag(data))).toPromise();
      return result;
    }
    if (obj.type == "dr") {
      // Display Rate
      const result = getBackendSrv().fetch(
        ...
        .pipe(map((data: any) => this.parseMetricFindQueryResultDr2(data))).toPromise();
      return result;
    }
    if (obj.type == "cinstance") {
      ...
      const result = getBackendSrv().fetch(
        {
          method: "GET",
          url: this.buildBaseUrl() + "/v1/topology?basicTag=" + encodeURIComponent(instanceTag) + "&vistaName=" + encodeURIComponent(vistaName),
          headers: { 'Range': 'items=1-' }
        })
        .pipe(map((data: any) => this.parseMetricFindQueryResult2Tag(data))).toPromise();
      return result;
  ...
  async doRequest(scopedVars: ScopedVars, target: MyQuery, startTime: DateTime, endTime: DateTime) {
    ...
    const instancesJson = (target.instance !== undefined && target.instance !== null) ? getTemplateSrv().replace(target.instance.value, scopedVars) : undefined;
...
return Promise.all(promises).then((data) => this.responseToDataQueryResponse(data));
  ...
  const v = { data: response.flatMap((data) => { return data }) };
  return v;
}
